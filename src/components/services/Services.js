...
export default class Services extends Component {
    ...
    render() {
           ...
           return (
                   ...
                   <div>
                        <div className="col-12 m-4 pl-5 pr-5 pt-2 pb-2 card-temp" style={{backgroundColor:"#FFEFFB",borderRadius:"1rem",textAlign:"center",height:"30rem",border:"3px #C92798 solid"}}>
                                <img src={photo} className="card-photo" alt="..." style={{width:"100%", height:"15rem",padding:"1%",borderRadius:"1rem"}}></img>
